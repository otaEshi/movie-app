...
function ViewAllPageTravel() {
    ...
    const travel = useAppSelector(store => store.search.search_list)
    ...
    const filteredTravel = travel.list.filter((item) =>
    ...
    const [genre, setGenre] = useState("Du lịch");
    ...
    return (
        ...
        //     <div>
        //         <div>
        //         <h1 style={{textAlign:'center'}}> Thể loại: Du lịch</h1>
        //             <div className='ms-4' >
