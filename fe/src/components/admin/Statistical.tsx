...
import { topTrendingForGenreRequest, topTrendingMoviesRequest } from "../homes/homeApi";
...
function Statistical() {
    ...
    const topTrendingMoviesAllGenreList = useAppSelector(store => store.home.trendingListAll);
    const handleGetTopTrendingAllMovies = () => {
        if (topTrendingAllMoviesNumber > 0) {
            ...
            dispatch(topTrendingMoviesRequest(payload))
        }
    }
